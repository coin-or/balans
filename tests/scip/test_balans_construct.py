...
class BalansConstructScipTest(BaseTest):
    ...
    def test_explicit_positional_construction(self):
        ...
        b = Balans(destroy_ops, repair_ops, selector, accept, stop, seed, mip_solver="scip")
    ...
    def test_explicit_all_destroy_families(self):
        ...
        b = Balans(destroy_ops, repair_ops, selector, accept, stop, seed=1283, mip_solver="scip")
    ...
    def test_accept_hill_climbing(self):
        ...
        b = Balans(
            ...
            selector=MABSelector(scores=[1, 1, 0, 0], num_destroy=1, num_repair=1,
                                 learning_policy=LearningPolicy.ThompsonSampling()),
            accept=HillClimbing(),
            stop=MaxIterations(1), seed=1283, mip_solver="scip")
        self.assertIsInstance(b.accept, HillClimbing)
    ...
    def test_stop_max_iterations(self):
        ...
        b = Balans(
            ...
            selector=MABSelector(scores=[1, 1, 0, 0], num_destroy=1, num_repair=1,
                                 learning_policy=LearningPolicy.ThompsonSampling()),
            accept=HillClimbing(),
            stop=MaxIterations(10), seed=1283, mip_solver="scip")
        self.assertIsInstance(b.stop, MaxIterations)
    ...
    def test_stop_max_runtime(self):
        ...
        b = Balans(
            ...
            selector=MABSelector(scores=[1, 1, 0, 0], num_destroy=1, num_repair=1,
                                 learning_policy=LearningPolicy.ThompsonSampling()),
            accept=HillClimbing(),
            stop=MaxRuntime(600), seed=1283, mip_solver="scip")
    ...
    def test_stop_no_improvement(self):
        ...
        b = Balans(
            ...
            selector=MABSelector(scores=[1, 1, 0, 0], num_destroy=1, num_repair=1,
                                 learning_policy=LearningPolicy.ThompsonSampling()),
            accept=HillClimbing(),
            stop=NoImprovement(100), seed=1283, mip_solver="scip")
    ...
    def test_seed_stored_correctly(self):
        ...
        b = Balans(
            ...
            selector=MABSelector(scores=[1, 1, 0, 0], num_destroy=1, num_repair=1,
                                 learning_policy=LearningPolicy.ThompsonSampling()),
            accept=HillClimbing(),
            stop=MaxIterations(1), seed=99999, mip_solver="scip")
    ...
    def test_n_mip_jobs_stored_correctly(self):
        ...
        b = Balans(
            ...
            selector=MABSelector(scores=[1, 1, 0, 0], num_destroy=1, num_repair=1,
                                 learning_policy=LearningPolicy.ThompsonSampling()),
            accept=HillClimbing(),
            stop=MaxIterations(1), seed=1283, n_mip_jobs=4, mip_solver="scip")
        self.assertEqual(b.n_mip_jobs, 4)

    def test_mip_solver_scip(self):
        """mip_solver_str should be 'scip'."""
        b = Balans(
            destroy_ops=[DestroyOperators.Mutation_50],
            repair_ops=[RepairOperators.Repair],
            selector=MABSelector(scores=[1, 1, 0, 0], num_destroy=1, num_repair=1,
    ...
    def test_config_with_explicit_mip_solver_override(self):
        ...
        config_path = os.path.normpath(os.path.join(Constants.DATA_TEST, '..', 'configs', 'test_config.json'))
        b = Balans(config=config_path, mip_solver="scip")
        self.assertEqual(b.mip_solver_str, "scip")
    ...
    def test_invalid_stop_type(self):
        ...
        with self.assertRaises(TypeError):
            Balans(
                ...
                selector=None,
                accept=HillClimbing(),
                stop="INVALID", seed=1283, mip_solver="scip")
    ...
    def test_str_contains_stop_type(self):
        ...
        b = Balans(
            ...
            selector=MABSelector(scores=[1, 1, 0, 0], num_destroy=1, num_repair=1,
                                 learning_policy=LearningPolicy.ThompsonSampling()),
            accept=HillClimbing(),
            stop=MaxIterations(7), seed=1283, mip_solver="scip")
        s = str(b)
    ...
    def test_str_contains_seed(self):
        ...
        b = Balans(
            ...
            selector=MABSelector(scores=[1, 1, 0, 0], num_destroy=1, num_repair=1,
                                 learning_policy=LearningPolicy.ThompsonSampling()),
            accept=HillClimbing(),
            stop=MaxIterations(1), seed=77777, mip_solver="scip")
        s = str(b)
