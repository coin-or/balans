...
class ParBalansTest(BaseTest):
    ...
    def test_parbalans(self):
        ...
        # TODO generate_random_balans always creates a SCIP solver.
        parbalans = ParBalans(n_jobs=2,
                              n_mip_jobs=1,
                              mip_solver=BaseTest.mip_solver,
                              output_dir="./tests/gurobi/parbalans/",
        ...
        with open("./tests/gurobi/parbalans/result_0.pkl", "rb") as file:
            result0 = pickle.load(file)
        with open("./tests/gurobi/parbalans/result_1.pkl", "rb") as file:
